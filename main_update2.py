...
def extension_for_url(country):
    df = pd.read_csv("/home/moka/Infoware/policy_pdf_scrapping/utils/WebScrap.csv")
    key =[]
    for i in df['Country']:
...
text_dir = '/home/moka/Infoware/policy_pdf_scrapping/output/summary.txt'
with open(text_dir,'a') as document:
    ...
    try:
        path1 = f'/home/moka/Infoware/policy_pdf_scrapping/output/{main_flder}'
        ...
        if not isExistsub:
            os.mkdir(path2)  
        path3 = f'/home/moka/Infoware/policy_pdf_scrapping/output/{main_flder}/{subflder}/policy'
        isExistsub_policy = os.path.exists(path3)
        if not isExistsub_policy:
            os.mkdir(path3)
        path4 = f'/home/moka/Infoware/policy_pdf_scrapping/output/{main_flder}/{subflder}/strategy'
        isExistsub_strategy = os.path.exists(path4)
        if not isExistsub_strategy:
            os.mkdir(path4)
        path5 = f'/home/moka/Infoware/policy_pdf_scrapping/output/{main_flder}/{subflder}/guildlines'
